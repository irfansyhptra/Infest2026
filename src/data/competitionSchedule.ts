...
const RAW_SCHEDULE: Record<string, ScheduleEvent[]> = {
  datascience: [
    ...
    { title: "Babak Penyisihan", start: "2026-09-14", end: "2026-09-25" },
    ...
    { title: "Pengumpulan Slide Presentasi Finalis", start: "2026-10-16" },
    { title: "Final Presentasi", start: "2026-10-17" },
  ...
  hackathon: [
    ...
    { title: "Pengumuman Juara (Onsite)", start: "2026-10-20" },
  ],
